...
import com.erinfa.videoPlayer.databinding.DetailsViewBinding
import com.erinfa.videoPlayer.databinding.RenameFieldBinding
import com.erinfa.videoPlayer.databinding.VideoMoreFeaturesBinding
import com.erinfa.videoPlayer.databinding.VideoViewBinding
import java.io.File
...
class VideoAdapter(private val context: Context, private var videoList: ArrayList<Video>, private var isFolder: Boolean = false)
    ...
    override fun onBindViewHolder(holder: MyHolder, @SuppressLint("RecyclerView") position: Int) {
        ...
        Glide.with(context)
            ...
            .apply(RequestOptions().placeholder(R.mipmap.ic_logo).centerCrop())
            .into(holder.image)
