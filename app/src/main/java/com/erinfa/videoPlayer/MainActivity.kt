...
import com.erinfa.videoPlayer.databinding.ActivityMainBinding
import com.erinfa.videoPlayer.databinding.ThemeViewBinding
...
//    }
    ...
    override fun onBackPressed() {
        ...
        if (binding.drawerLayoutMA.isDrawerOpen(GravityCompat.START)){
            binding.drawerLayoutMA.closeDrawer(Gravity.LEFT)
        }else{
